*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_ZSDSCOC001
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_ZSDSCOC001    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_ZSDSCOC001'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_ZSDSCOC001_EXTRACT
TOTAL = ZSDSV_ZSDSCOC001_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_ZSDSCOC001'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_ZSDSCOC001-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_ZSDSCOC001_EXTRACT
TOTAL = ZSDSV_ZSDSCOC001_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_ZSDSCOC001-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_ZSDSCOC001'
...
TOTAL = ZSDSV_ZSDSCOC001_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_ZSDSCOC001-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_ZSDSCOC001-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_ZSDSCOC001'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_ZSDSCOC001-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_ZSDSCOC001_EXTRACT
TOTAL = ZSDSV_ZSDSCOC001_TOTAL
