*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_PRODH_APUP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_PRODH_APUP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_PRODH_APUP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_PRODH_APUP_EXTRACT
TOTAL = ZSDSV_PRODH_APUP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_PRODH_APUP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_PRODH_APUP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_PRODH_APUP_EXTRACT
TOTAL = ZSDSV_PRODH_APUP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_PRODH_APUP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_PRODH_APUP'
...
TOTAL = ZSDSV_PRODH_APUP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_PRODH_APUP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_PRODH_APUP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_PRODH_APUP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_PRODH_APUP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_PRODH_APUP_EXTRACT
TOTAL = ZSDSV_PRODH_APUP_TOTAL
