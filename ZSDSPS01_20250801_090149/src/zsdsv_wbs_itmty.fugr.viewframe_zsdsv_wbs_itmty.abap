*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_WBS_ITMTY
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_WBS_ITMTY     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_WBS_ITMTY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_WBS_ITMTY_EXTRACT
TOTAL = ZSDSV_WBS_ITMTY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_WBS_ITMTY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_WBS_ITMTY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_WBS_ITMTY_EXTRACT
TOTAL = ZSDSV_WBS_ITMTY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_WBS_ITMTY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_WBS_ITMTY'
...
TOTAL = ZSDSV_WBS_ITMTY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_WBS_ITMTY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_WBS_ITMTY-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_WBS_ITMTY'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_WBS_ITMTY-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_WBS_ITMTY_EXTRACT
TOTAL = ZSDSV_WBS_ITMTY_TOTAL
