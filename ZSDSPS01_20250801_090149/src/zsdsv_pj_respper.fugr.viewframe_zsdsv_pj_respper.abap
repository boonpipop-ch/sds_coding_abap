*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_PJ_RESPPER
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_PJ_RESPPER    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_PJ_RESPPER'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_PJ_RESPPER_EXTRACT
TOTAL = ZSDSV_PJ_RESPPER_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_PJ_RESPPER'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_PJ_RESPPER-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_PJ_RESPPER_EXTRACT
TOTAL = ZSDSV_PJ_RESPPER_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_PJ_RESPPER-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_PJ_RESPPER'
...
TOTAL = ZSDSV_PJ_RESPPER_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_PJ_RESPPER-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_PJ_RESPPER-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_PJ_RESPPER'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_PJ_RESPPER-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_PJ_RESPPER_EXTRACT
TOTAL = ZSDSV_PJ_RESPPER_TOTAL
