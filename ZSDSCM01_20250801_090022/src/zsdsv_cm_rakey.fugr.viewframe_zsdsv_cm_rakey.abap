*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_CM_RAKEY
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_CM_RAKEY      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_CM_RAKEY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_CM_RAKEY_EXTRACT
TOTAL = ZSDSV_CM_RAKEY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_CM_RAKEY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_CM_RAKEY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_CM_RAKEY_EXTRACT
TOTAL = ZSDSV_CM_RAKEY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_CM_RAKEY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_CM_RAKEY'
...
TOTAL = ZSDSV_CM_RAKEY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_CM_RAKEY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_CM_RAKEY-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_CM_RAKEY'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_CM_RAKEY-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_CM_RAKEY_EXTRACT
TOTAL = ZSDSV_CM_RAKEY_TOTAL
