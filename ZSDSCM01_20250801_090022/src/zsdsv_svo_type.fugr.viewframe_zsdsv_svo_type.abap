*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_SVO_TYPE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_SVO_TYPE      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_SVO_TYPE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_SVO_TYPE_EXTRACT
TOTAL = ZSDSV_SVO_TYPE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_SVO_TYPE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_SVO_TYPE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_SVO_TYPE_EXTRACT
TOTAL = ZSDSV_SVO_TYPE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_SVO_TYPE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_SVO_TYPE'
...
TOTAL = ZSDSV_SVO_TYPE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_SVO_TYPE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_SVO_TYPE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_SVO_TYPE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_SVO_TYPE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_SVO_TYPE_EXTRACT
TOTAL = ZSDSV_SVO_TYPE_TOTAL
