class ZL_BT112H_S_OVVIEWSET_IMPL definition
  public
  inheriting from CL_BT112H_S_OVVIEWSET_IMPL
  create public .

public section.
protected section.

  data ZTYPED_CONTEXT type ref to ZL_BT112H_S_OVVIEWSET_CTXT .
...
CLASS ZL_BT112H_S_OVVIEWSET_IMPL IMPLEMENTATION.
...
*   create the context
    context = cl_bsp_wd_context=>get_instance(
          iv_controller = me
          iv_type = 'ZL_BT112H_S_OVVIEWSET_CTXT' ).
