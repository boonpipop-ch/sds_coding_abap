*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_MAT_WRT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_MAT_WRT       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_MAT_WRT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_MAT_WRT_EXTRACT
TOTAL = ZSDSV_MAT_WRT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_MAT_WRT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_MAT_WRT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_MAT_WRT_EXTRACT
TOTAL = ZSDSV_MAT_WRT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_MAT_WRT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_MAT_WRT'
...
TOTAL = ZSDSV_MAT_WRT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_MAT_WRT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_MAT_WRT-UPD_FLAG NE SPACE.
