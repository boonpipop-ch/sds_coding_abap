*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_CM_GLACC
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_CM_GLACC      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_CM_GLACC'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_CM_GLACC_EXTRACT
TOTAL = ZSDSV_CM_GLACC_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_CM_GLACC'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_CM_GLACC-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_CM_GLACC_EXTRACT
TOTAL = ZSDSV_CM_GLACC_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_CM_GLACC-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_CM_GLACC'
...
TOTAL = ZSDSV_CM_GLACC_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_CM_GLACC-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_CM_GLACC-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_CM_GLACC'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_CM_GLACC-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_CM_GLACC_EXTRACT
TOTAL = ZSDSV_CM_GLACC_TOTAL
