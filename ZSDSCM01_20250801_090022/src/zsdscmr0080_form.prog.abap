...
*&      --> I_DATA
*&---------------------------------------------------------------------*
FORM F_BDC_DATA  USING I_DATA TYPE GY_RESULT.
  CLEAR : BDCDATA[],MESSTAB[].

  PERFORM BDC_DYNPRO   USING  'SAPMIEQ0'   '1000'.
  PERFORM BDC_FIELD    USING  'BDC_CURSOR' 'RISA0-SERNR'.
  PERFORM BDC_FIELD    USING  'BDC_OKCODE' '/00'.
  PERFORM BDC_FIELD    USING  'RISA0-MATNR' I_DATA-MATERIAL.
  PERFORM BDC_FIELD    USING  'RISA0-SERNR' I_DATA-SERIAL_NEW.
  PERFORM BDC_FIELD    USING  'RM63E-EQTYP' 'S'.

  PERFORM BDC_DYNPRO   USING  'SAPMIEQ0'   '0101'.
  PERFORM BDC_FIELD    USING  'BDC_OKCODE' '=BU'.

  PERFORM BDC_TRANSACTION USING 'IQ01'.
ENDFORM.
