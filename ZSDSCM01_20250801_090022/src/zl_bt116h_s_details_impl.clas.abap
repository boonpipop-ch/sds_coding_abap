class ZL_BT116H_S_DETAILS_IMPL definition
  public
  inheriting from CL_BT116H_S_DETAILS_IMPL
  create public .

public section.
protected section.

  data ZTYPED_CONTEXT type ref to ZL_BT116H_S_DETAILS_CTXT .
...
CLASS ZL_BT116H_S_DETAILS_IMPL IMPLEMENTATION.
...
*   create the context
    context = cl_bsp_wd_context=>get_instance(
            iv_controller = me
            iv_type = 'ZL_BT116H_S_DETAILS_CTXT' ).
