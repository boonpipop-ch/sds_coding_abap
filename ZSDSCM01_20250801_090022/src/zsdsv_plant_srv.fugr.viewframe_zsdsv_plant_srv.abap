*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_PLANT_SRV
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_PLANT_SRV     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_PLANT_SRV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_PLANT_SRV_EXTRACT
TOTAL = ZSDSV_PLANT_SRV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_PLANT_SRV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_PLANT_SRV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_PLANT_SRV_EXTRACT
TOTAL = ZSDSV_PLANT_SRV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_PLANT_SRV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_PLANT_SRV'
...
TOTAL = ZSDSV_PLANT_SRV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_PLANT_SRV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_PLANT_SRV-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_PLANT_SRV'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_PLANT_SRV-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_PLANT_SRV_EXTRACT
TOTAL = ZSDSV_PLANT_SRV_TOTAL
