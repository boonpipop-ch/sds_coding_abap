...
DATA:
  ...
  gf_header_hight       TYPE i VALUE 20,                    "#EC NEEDED
  gf_second_alv         TYPE flag,                          "#EC NEEDED
  gf_alv_height         TYPE i VALUE 20,                    "#EC NEEDED
  ...
  PUBLIC SECTION.
    CLASS-METHODS:
      ...
      on_double_click      FOR EVENT double_click OF cl_gui_alv_grid
        IMPORTING e_row e_column  ##NEEDED,
...
* to react on oi_custom_events:
  ...
  CASE gf_save_ok.
    WHEN 'BACK'.
      PERFORM f_unlock_tran.
*      PERFORM f_unlock_tran_new_entry. "<<F36K917933 - 03 del
      LEAVE TO SCREEN 0.
    WHEN 'END'.
      PERFORM f_unlock_tran.
*      PERFORM f_unlock_tran_new_entry. "<<F36K917933 - 03 del
