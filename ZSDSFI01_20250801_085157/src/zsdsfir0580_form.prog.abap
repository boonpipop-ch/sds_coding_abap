...
FORM F_CALL_TRANSECTION.
  ...
  IF SY-SUBRC = 0.
    LR_WBSE[] =  VALUE #( ( SIGN  = 'I' OPTION = 'EQ' LOW = GS_RESULT-PSPNR ) ).
    SUBMIT ZSDSFIR0730 USING SELECTION-SCREEN  1000
                            WITH S_WBSE IN LR_WBSE[]
