*-----------------------------------------------------------------------
*  Program ID         : ZSDSFIR0030
*  Creation Date      : 24.01.2024
*  Author             : Wantanee Prateep na thalang
*  Add-on ID          : ZFIAPE004
*  Description        : Report Export employee advance to text file
*  Purpose            :
...
*
*END OF ty_itab_regis.
*
*TYPES: BEGIN OF ty_bsak_pay,
...
*END OF ty_bsad_clear.
*TYPES: BEGIN OF ty_bsid_clear,
*       lifnr               TYPE bsak-lifnr,         "Vender
...
*END OF ty_bsid_clear.
*
*TYPES: BEGIN OF ty_bsak_inv,
*       lifnr               TYPE bsak-lifnr,         "Vender
*       augbl               TYPE bsak-augbl,         "Doc.Payment
*       auggj               TYPE bsak-auggj,         "Fiscal Year
...
*       remark(50)      TYPE c,
*
*END OF typ_rep_excel.
*TYPES: BEGIN OF ty_exp_excel,
*       run_no(3)       TYPE c,
*       name(100)       TYPE c,
*       acc_bank(18)    TYPE c,
*       bank_amt(15)    TYPE c,
...
*       remark(20)      TYPE c,
*END OF ty_exp_excel.
*TYPES: BEGIN OF ty_exp_excel_header,
*       header_name(50)       TYPE c,
*
*END OF ty_exp_excel_header.
*TYPES: BEGIN OF typ_payee_code,
*       lifnr          TYPE lfa1-lifnr,
*       pay_name(100)  TYPE c,
*       email          TYPE adr6-smtp_addr,    "E-mail Address
...
*       branch_code(4)       TYPE c,                 "Branch Code
*       branch_name(80)      TYPE c,                 "Branch Name
*END OF typ_payee_code.
*"CH04 Add by Wantanee 20210111
*TYPES: BEGIN OF ty_product_code,
*       product_code(3) TYPE c,    "
*       z_payamt        TYPE bsis-dmbtr,
*       no_of_credit    TYPE i,
*END OF ty_product_code.
...
*END OF ty_regis.
*
*TYPES: BEGIN OF ty_ztfi_bank,
*       bankl        TYPE ztfi_bank-bankl,   "Bank Key
*       bank_code    TYPE ztfi_bank-bank_code,  "Bank Code
*END OF ty_ztfi_bank.
*
...
*END OF ty_lfa1.
*
*TYPES: BEGIN OF ty_ztfi_vender_bank,
*     mandt      TYPE ztfi_vender_bank-mandt,
*     lifnr      TYPE ztfi_vender_bank-lifnr,
*     flag_email TYPE ztfi_vender_bank-flag_email,
*     flag_fax   TYPE ztfi_vender_bank-flag_email,
*     kunnr      TYPE ztfi_vender_bank-kunnr,
*     bankl      TYPE ztfi_vender_bank-bankl,
*     bankn      TYPE ztfi_vender_bank-bankn,
*     bkref      TYPE ztfi_vender_bank-bkref,
*     bank_code  TYPE ztfi_vender_bank-bank_code,
*     banka      TYPE ztfi_vender_bank-banka,
*
*
*END OF ty_ztfi_vender_bank.
*
...
*
*
*"CH6 Add by WAntanee 20210713
*
*TYPES: BEGIN OF typ_summary_togm,
*       pay_doc              TYPE bsak-augbl,        "Payment Doc.
*       pay_amt              TYPE bsak-dmbtr,        "Payment Amount
*       pay_date             TYPE bkpf-budat,        "Payment date
*
*END OF typ_summary_togm.
*"CH6 End Add by Wantanee 2021
*
*
*
*TYPE-POOLS : vrm.
...
*      gt_itab_regis   TYPE STANDARD TABLE OF ty_itab_regis,
*      gt_bsak_pay     TYPE STANDARD TABLE OF ty_bsak_pay,
*      gt_bsak_pay_tmp TYPE STANDARD TABLE OF ty_bsak_pay,
*      gt_bsad_clear   TYPE STANDARD TABLE OF ty_bsad_clear,  "Add by Wantanee 20140306
*      gt_bsid_clear   TYPE STANDARD TABLE OF ty_bsid_clear,"Add by Wantanee 20140306
*      gt_bsak_inv     TYPE STANDARD TABLE OF ty_bsak_inv,
*      gt_adrc         TYPE STANDARD TABLE OF ty_adrc,
*      gt_with_item    TYPE STANDARD TABLE OF ty_with_item,
*      gt_t059zt       TYPE STANDARD TABLE OF ty_t059zt,
*      gt_gen_c        TYPE STANDARD TABLE OF ty_gen_c,
...
*      gt_bank         TYPE STANDARD TABLE OF ty_ztfi_bank,
*      gt_regis        TYPE STANDARD TABLE OF ty_regis,
*      gt_lfa1         TYPE STANDARD TABLE OF ty_lfa1,
*      gt_ztfi_vender_bank TYPE STANDARD TABLE OF ty_ztfi_vender_bank,
*      gt_bsis         TYPE STANDARD TABLE OF ty_bsis,
*      gt_bsec         TYPE STANDARD TABLE OF ty_bsec,
*      gt_ex_excel     TYPE STANDARD TABLE OF ty_exp_excel,
*      gt_rep_excel    TYPE STANDARD TABLE OF typ_rep_excel,
*      gt_send_mail    TYPE STANDARD TABLE OF typ_rep_excel,
*      gt_payee_code   TYPE STANDARD TABLE OF typ_payee_code,
*      gt_ex_excel_h   TYPE STANDARD TABLE OF ty_exp_excel_header,
*      gt_001          TYPE STANDARD TABLE OF ty_001,
*      gt_002          TYPE STANDARD TABLE OF ty_002,
*      gt_pay          TYPE STANDARD TABLE OF ty_pay_003,
*      gt_pay_004      TYPE STANDARD TABLE OF ty_pay_004,
*      gt_999          TYPE STANDARD TABLE OF ty_999,
*      gt_product_code    TYPE STANDARD TABLE OF ty_product_code. "CH04 Add by WAntanee 20210111
*
*
*DATA: gs_itab         TYPE ty_itab,
*      gs_itab_regis   TYPE ty_itab_regis,
*      gs_bsak_pay     TYPE ty_bsak_pay,
*      gs_bsak_pay_tmp TYPE ty_bsak_pay,
*      gs_bsad_clear   TYPE ty_bsad_clear, "Add by Wantanee 20140306
*      gs_bsid_clear   TYPE ty_bsid_clear,
*      gs_bsak_inv     TYPE ty_bsak_inv,
*      gs_adrc         TYPE ty_adrc,
*      gs_with_item    TYPE ty_with_item,
*      gs_t059zt       TYPE ty_t059zt,
*      gs_gen_c        TYPE ty_gen_c,
...
*      gs_inv          TYPE ty_inv,
*      gs_bank         TYPE ty_ztfi_bank,
*      gs_regis        TYPE ty_regis,
*      gs_lfa1         TYPE ty_lfa1,
*      gs_ztfi_vender_bank TYPE ty_ztfi_vender_bank,
*      gs_bsis         TYPE ty_bsis,
*      gs_bsec         TYPE ty_bsec,
*      gs_ex_excel     TYPE ty_exp_excel,
*      gs_rep_excel    TYPE typ_rep_excel,
*      gs_send_mail    TYPE typ_rep_excel,
*      gs_payee_code   TYPE typ_payee_code,
*      gs_ex_excel_h   TYPE ty_exp_excel_header,
*      gs_001          TYPE ty_001,
*      gs_002          TYPE ty_002,
*      gs_pay          TYPE ty_pay_003,
*      gs_pay_004      TYPE ty_pay_004,
*      gs_999          TYPE ty_999,
*      gs_product_code    TYPE  ty_product_code. "CH04 Add by WAntanee 20210111
*
*
*"CH6 Add by WAntanee 20210713
*DATA: gt_summary_togm TYPE STANDARD TABLE OF typ_summary_togm,
*      gw_summary_togm TYPE typ_summary_togm.
*"CH6 End Add by Wantanee 20210713
*
...
*           gc_repid    TYPE zsds_gen_c-repid VALUE 'ZR_FIAP_ADVANCE'.
*
...
*PARAMETERS: p_mailgm TYPE so_recname DEFAULT 'wantanee@daikin.co.th', "'chuleekorn@daikin.co.th',
*            p_gmname TYPE char35 DEFAULT 'CHULEEKORN SOOKJARUST'.
...
*         READ TABLE gt_ztfi_vender_bank INTO gs_ztfi_vender_bank WITH KEY lifnr = gs_bsak_pay-lifnr.
*              IF sy-subrc EQ 0.
...
*
*                "CH6 Add by WAntanee  20210713
*                     CLEAR: gw_summary_togm.
*                     gw_summary_togm-pay_doc = gs_itab-pay_doc.
*                     gw_summary_togm-pay_amt = gs_itab-pay_amt.
*                     gw_summary_togm-pay_date = gs_itab-pay_date.
*
*                     COLLECT  gw_summary_togm INTO gt_summary_togm.
*                "CH6 End Add by Wantanee 20210713
*
*
*
...
*
*
*                 CONCATENATE gs_itab-bank_code gs_itab-bank_name INTO gs_rep_excel-bank_name SEPARATED BY ':'.
...
*                  gs_payee_code-bank_code = gs_itab-bank_code.
...
*
*        IF gs_payee_code-bank_code EQ '014'.
*            gs_product_code-product_code =   'PAY'. "
*        ELSE.
*            gs_product_code-product_code =   'MCL'.
*        ENDIF.
...
*   ENDLOOP.
*
*   IF gt_summary_togm IS NOT INITIAL.
*         CLEAR: lv_post_date.
*         CONCATENATE p_post+6(2) p_post+4(2) p_post+0(4) INTO  lv_post_date SEPARATED BY '.'.
*
*
*            CALL FUNCTION 'Z_SEND_EMAIL_ADV_GM'
*              EXPORTING
*                P_RECIEVER       = p_mailgm
*                P_REPNAM         = p_gmname
*                P_PAYDATE        = lv_post_date
*              TABLES
*                I_DETAIL         = gt_summary_togm
*                      .
*
*
*   ENDIF.
...
*                              value(p_bank_code) TYPE c
*                              value(p_branch_code) TYPE c
*                              value(p_bankl) TYPE bnka-bankl.
*
*
*
*     CLEAR:p_banka,p_bankn,p_bkref,p_bank_code,p_branch_code,p_bankl.
**       lifnr        TYPE lfbk-lifnr,
**       banks        TYPE bnka-banks,   "Bank th
**       bankl        TYPE bnka-bankl,   "Bank Key
**       bankn        TYPE lfbk-bankn,   "Bank Account
...
**                       gs_pay-wht_remark
**                       gs_pay-wht_deduct_date
*                       "CH04 Remove by Wantanee 20210111
**                       gs_pay-receive_bank_code = '014'.
**                       gs_pay-receive_bank_name = 'SIAM COMMERCIAL BANK'.
**                        CONCATENATE '0' gs_ex_excel-acc_bank+0(3) INTO  gs_pay-receive_branch_code.
*                       "CH04 End Remove by Wantanee 20210111
*                       "CH04 Add by Wantanee 20210111
*                       gs_pay-receive_bank_code = gs_payee_code-bank_code.
*                       gs_pay-receive_bank_name = gs_payee_code-bank_name.
*                       gs_pay-receive_branch_code =    gs_payee_code-branch_code.
*                       "CH04 End Add by WAntanee 20210111
*
**                       gs_pay-receive_branch_name
**                       gs_pay-wht_signatory
*                       gs_pay-beneficiary = 'E'.
*                       gs_pay-cust_ref = lv_remark.
**                       gs_pay-cheque_refer
**                       gs_pay-payment_type_code
...
*                                      gs_pay-receive_bank_code  gs_pay-receive_bank_name gs_pay-receive_branch_code
...
*          ENDLOOP.
*
*          "CH04Remove by WAntanee 20210111
**                  LOOP AT gt_payee_code INTO gs_payee_code WHERE product_code = gs_002-product_code.
**                        CLEAR: lv_remark,lv_payamt,gs_pay,gs_pay_004.
**                        lv_runno = lv_runno + 1.
**                        gs_rep_excel-lifnr = gs_payee_code-lifnr.
