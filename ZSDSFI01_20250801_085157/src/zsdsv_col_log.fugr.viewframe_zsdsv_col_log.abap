*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_COL_LOG
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_COL_LOG       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_LOG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_COL_LOG_EXTRACT
TOTAL = ZSDSV_COL_LOG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_LOG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_COL_LOG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_COL_LOG_EXTRACT
TOTAL = ZSDSV_COL_LOG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_COL_LOG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_LOG'
...
TOTAL = ZSDSV_COL_LOG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_COL_LOG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_COL_LOG-UPD_FLAG NE SPACE.
