*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_COL_STATUS
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_COL_STATUS    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_STATUS'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_COL_STATUS_EXTRACT
TOTAL = ZSDSV_COL_STATUS_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_STATUS'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_COL_STATUS-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_COL_STATUS_EXTRACT
TOTAL = ZSDSV_COL_STATUS_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_COL_STATUS-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_STATUS'
...
TOTAL = ZSDSV_COL_STATUS_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_COL_STATUS-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_COL_STATUS-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_STATUS'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_COL_STATUS-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_COL_STATUS_EXTRACT
TOTAL = ZSDSV_COL_STATUS_TOTAL
