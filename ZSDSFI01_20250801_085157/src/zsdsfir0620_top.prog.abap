*&---------------------------------------------------------------------*
*& Include          ZSDSFIR0620_TOP
*&---------------------------------------------------------------------*
*-----------------------------------------------------------------------
* T A B L E S
*-----------------------------------------------------------------------
TABLES : EQBS,EQUI,MSEG.
*-----------------------------------------------------------------------
* T Y P E S
*-----------------------------------------------------------------------
TYPES : BEGIN OF GY_RESULT.
          INCLUDE TYPE ZSDSVC_GET_REMAIN_SERIAL.
TYPES:    CHECK      TYPE C,
          QTY        TYPE P DECIMALS 0,
          MFRNR      TYPE MARA-MFRNR,
          NAME_ALL   TYPE C LENGTH 160,
          YEAR       TYPE P DECIMALS 2,
          AGEING     TYPE P,
          AGINGDAY   TYPE P,
          FLAG_RE100 TYPE C,
          FLAG_RE50  TYPE C,
          COST_ALL   TYPE P DECIMALS 2,
        END OF GY_RESULT.
