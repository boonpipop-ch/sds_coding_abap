...
DATA:
  ...
  gf_header_hight       TYPE i VALUE 40,                    "#EC NEEDED
...
* Check ALV 1 in Edit Mode?
  ...
  IF gv_data_type = gc_tab_sel-history_log.
    APPEND gc_func-post_inc TO gt_excl.
  ENDIF.
...
* to react on oi_custom_events:
  ...
  CASE gf_save_ok.
    WHEN 'BACK'.
      ...
      ELSEIF gv_data_type = gc_tab_sel-new_entry.
