*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_COL_INFO
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_COL_INFO      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_INFO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_COL_INFO_EXTRACT
TOTAL = ZSDSV_COL_INFO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_INFO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_COL_INFO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_COL_INFO_EXTRACT
TOTAL = ZSDSV_COL_INFO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_COL_INFO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_INFO'
...
TOTAL = ZSDSV_COL_INFO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_COL_INFO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_COL_INFO-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_COL_INFO'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_COL_INFO-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_COL_INFO_EXTRACT
TOTAL = ZSDSV_COL_INFO_TOTAL
