...
TYPES : BEGIN OF GY_RESULT,
          ...
          PERNR_IN TYPE ZSDSFIT050-PERNR,
          KOSTL_IN TYPE ZSDSFIT050-KOSTL,
          REMARK   TYPE ZSDSFIT050-REMARK,
          STATU    TYPE ZSDSFIT050-STATU,
          ERNAM    TYPE ZSDSFIT050-ERNAM,
          ERDAT    TYPE ZSDSFIT050-ERDAT,
          ERZET    TYPE ZSDSFIT050-ERZET,
          AENAM    TYPE ZSDSFIT050-AENAM,
          AEDAT    TYPE ZSDSFIT050-AEDAT,
          AEZET    TYPE ZSDSFIT050-AEZET,
          OWNNA    TYPE C LENGTH 100,
          MGNNA    TYPE C LENGTH 100,
          INPNA    TYPE C LENGTH 100,
          KTEXT    TYPE T499S-KTEXT,
          LTEXT    TYPE CSKT-LTEXT,
          DIF      TYPE C LENGTH 255,
          CHECK    TYPE C,
        END OF GY_RESULT.
