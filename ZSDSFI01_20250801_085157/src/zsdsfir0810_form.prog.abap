...
FORM F_EXPORT_MEMORY .
  ...
  LV_SGTXT = GS_HEADER-ITEM_TEXT.

  CONCATENATE 'ZSDSFIR0810' SY-UNAME INTO LV_MEMMORY. "Class ZCL_SDSFI_ENHANCEMENT method UPDATE_BSEG
  EXPORT LV_SGTXT TO MEMORY ID LV_MEMMORY.
