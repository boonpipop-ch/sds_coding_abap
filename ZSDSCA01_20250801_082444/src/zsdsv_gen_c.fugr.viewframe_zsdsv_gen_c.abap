*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_GEN_C
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_GEN_C         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_GEN_C'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_GEN_C_EXTRACT
TOTAL = ZSDSV_GEN_C_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_GEN_C'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_GEN_C-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_GEN_C_EXTRACT
TOTAL = ZSDSV_GEN_C_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_GEN_C-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_GEN_C'
...
TOTAL = ZSDSV_GEN_C_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_GEN_C-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_GEN_C-UPD_FLAG NE SPACE.
