*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_REST_INTF
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_REST_INTF     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_REST_INTF'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_REST_INTF_EXTRACT
TOTAL = ZSDSV_REST_INTF_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_REST_INTF'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_REST_INTF-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_REST_INTF_EXTRACT
TOTAL = ZSDSV_REST_INTF_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_REST_INTF-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_REST_INTF'
...
TOTAL = ZSDSV_REST_INTF_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_REST_INTF-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_REST_INTF-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_REST_INTF'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_REST_INTF-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_REST_INTF_EXTRACT
TOTAL = ZSDSV_REST_INTF_TOTAL
