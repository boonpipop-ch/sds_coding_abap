...
*----------------------------------------------------------------------*
CONSTANTS:
  GC_TCODE        TYPE  SY-TCODE    VALUE 'ZSDSCA008',
...
SELECTION-SCREEN BEGIN OF BLOCK B1 WITH FRAME TITLE TEXT-S01 .
  PARAMETERS:
    RB_TYPE1 TYPE  FLAG RADIOBUTTON GROUP G2
                        USER-COMMAND TPL.
...
* Text-s12:
  ...
  PARAMETERS:
    RB_TYPE2 TYPE  FLAG RADIOBUTTON GROUP G2   DEFAULT 'X' ##NEEDED.
...
*     Text-s04: Start Column
    SELECTION-SCREEN COMMENT 50(15) TEXT-S09 FOR FIELD P_BEGCOL ##SEL_WRONG
      MODIF ID EXC.
    PARAMETERS:
      P_BEGCOL TYPE I DEFAULT 4 MODIF ID EXC.
  SELECTION-SCREEN END OF LINE.
...
INCLUDE ZSDSCAR0100_F05.
*INCLUDE ZSDSCAR0090_F05.
*INCLUDE ZSDSCAR0050_F05.

INCLUDE ZSDSCAR0100_F06.
