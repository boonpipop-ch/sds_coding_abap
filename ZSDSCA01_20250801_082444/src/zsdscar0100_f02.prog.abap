...
* BOI - CH01 - 05.11.2024
      IF SY-SUBRC NE 0.
        PV_PARTNER = PS_DATA-KEY-PARTNER.
      ENDIF.
* EOI - CH01 - 05.11.2024
...
*& text
*&---------------------------------------------------------------------*
FORM F_ASSIGN_BAPI_ADDRESS USING PV_TYPE TYPE BUT000-TYPE   ##CALLED
...
*& Assign Bank Detail Data
*&---------------------------------------------------------------------*
FORM F_ASSIGN_BAPI_BANKDETAIL USING PS_BANK TYPE GTY_BANK    ##CALLED
