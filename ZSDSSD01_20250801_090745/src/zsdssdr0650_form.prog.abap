...
FORM F_PRINT .
  ...
  LOOP AT LT_TMP INTO GS_RESULT WHERE CHECK EQ ABAP_TRUE.
*--------------------------------------------------------------------*
    LV_NO_DIALOG       = SPACE.
*--------------------------------------------------------------------*
    LS_NAST-KAPPL      = 'V3'.
    LS_NAST-OBJKY      = GS_RESULT-VBELN.
    LS_NAST-KSCHL      = P_KSCHL.
    LS_NAST-SPRAS      = '2'.
    LS_NAST-PARNR      = GS_RESULT-KUNRG.
    LS_NAST-PARVW      = 'RE'.
...
*--------------------------------------------------------------------*
    ...
    UPDATE ZSDSSDT026 SET PRINF = ABAP_TRUE
                    WHERE VBELN EQ GS_RESULT-VBELN.
