*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_ETAX_DOCTY
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_ETAX_DOCTY    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_ETAX_DOCTY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_ETAX_DOCTY_EXTRACT
TOTAL = ZSDSV_ETAX_DOCTY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_ETAX_DOCTY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_ETAX_DOCTY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_ETAX_DOCTY_EXTRACT
TOTAL = ZSDSV_ETAX_DOCTY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_ETAX_DOCTY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_ETAX_DOCTY'
...
TOTAL = ZSDSV_ETAX_DOCTY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_ETAX_DOCTY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_ETAX_DOCTY-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_ETAX_DOCTY'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_ETAX_DOCTY-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_ETAX_DOCTY_EXTRACT
TOTAL = ZSDSV_ETAX_DOCTY_TOTAL
