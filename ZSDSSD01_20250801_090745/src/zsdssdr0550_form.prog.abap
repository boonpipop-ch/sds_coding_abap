...
FORM F_CHECK_BOX  USING LV_CHECK.
  GS_RESULT-CONTF = LV_CHECK.
  MODIFY GT_RESULT FROM GS_RESULT TRANSPORTING CONTF
                                         WHERE CONTF NE GS_RESULT-CONTF.
*  MODIFY GT_RESULT FROM GS_RESULT TRANSPORTING FLAGD
*                                         WHERE FLAGD NE GS_RESULT-CONTF.
