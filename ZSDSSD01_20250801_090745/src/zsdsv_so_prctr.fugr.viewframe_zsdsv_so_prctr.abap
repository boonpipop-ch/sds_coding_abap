*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_SO_PRCTR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_SO_PRCTR      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_SO_PRCTR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_SO_PRCTR_EXTRACT
TOTAL = ZSDSV_SO_PRCTR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_SO_PRCTR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_SO_PRCTR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_SO_PRCTR_EXTRACT
TOTAL = ZSDSV_SO_PRCTR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_SO_PRCTR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_SO_PRCTR'
...
TOTAL = ZSDSV_SO_PRCTR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_SO_PRCTR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_SO_PRCTR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_SO_PRCTR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_SO_PRCTR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_SO_PRCTR_EXTRACT
TOTAL = ZSDSV_SO_PRCTR_TOTAL
