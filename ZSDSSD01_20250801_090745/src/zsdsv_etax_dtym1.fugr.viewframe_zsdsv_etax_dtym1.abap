*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_ETAX_DTYM1
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_ETAX_DTYM1    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_ETAX_DTYM1'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_ETAX_DTYM1_EXTRACT
TOTAL = ZSDSV_ETAX_DTYM1_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_ETAX_DTYM1'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_ETAX_DTYM1-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_ETAX_DTYM1_EXTRACT
TOTAL = ZSDSV_ETAX_DTYM1_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_ETAX_DTYM1-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_ETAX_DTYM1'
...
TOTAL = ZSDSV_ETAX_DTYM1_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_ETAX_DTYM1-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_ETAX_DTYM1-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_ETAX_DTYM1'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_ETAX_DTYM1-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_ETAX_DTYM1_EXTRACT
TOTAL = ZSDSV_ETAX_DTYM1_TOTAL
