...
*  30.01.2025  420000353   Zulkiff B.  Toggle Print Warranty Form Eng/Th
*  06.02.2025  420000361   Jutamas Y.  Display According , Thai Fonts
*  07.03.2025  420000475   Jutamas Y.  Display Serial no.
*  08.04.2025  420000406   Zulkiff B.  Bug fixing: Billing before DO
*-----------------------------------------------------------------------
REPORT ZSDSCMD0010.
...
CONSTANTS:
  ...
  GC_FORM_EN     TYPE TDSFNAME VALUE 'ZSDSCM001_EN',
  GC_FORM_TH     TYPE TDSFNAME VALUE 'ZSDSCM001_TH' ##NEEDED,
  ...
  IF SY-UCOMM = 'MASS' OR SY-UCOMM = SPACE.
    CASE 'X'.
      WHEN R_CRE.
        ...
        ENDIF.
*        IF SY-UCOMM = SPACE AND P_POSID IS NOT INITIAL.
