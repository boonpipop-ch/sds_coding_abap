...
*  Author             : Wantanee Pr.
*  Add-on ID          :
*  Description        : VF01 Issue invoice from BDR check Confrimation reference to GR part all item completed.
*  Purpose            :
*  Copied from        :
*  Restriction        :
*-----------------------------------------------------------------------
...
FORM CALL_VF01 .
  ...
  CALL TRANSACTION 'VF01' USING LT_BDCDATA OPTIONS FROM LWA_OPT.
