*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_DELIVERYTO
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_DELIVERYTO    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_DELIVERYTO'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_DELIVERYTO_EXTRACT
TOTAL = ZSDSV_DELIVERYTO_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_DELIVERYTO'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_DELIVERYTO-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_DELIVERYTO_EXTRACT
TOTAL = ZSDSV_DELIVERYTO_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_DELIVERYTO-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_DELIVERYTO'
...
TOTAL = ZSDSV_DELIVERYTO_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_DELIVERYTO-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_DELIVERYTO-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_DELIVERYTO'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_DELIVERYTO-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_DELIVERYTO_EXTRACT
TOTAL = ZSDSV_DELIVERYTO_TOTAL
