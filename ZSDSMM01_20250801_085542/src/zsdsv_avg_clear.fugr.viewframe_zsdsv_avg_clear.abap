*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_AVG_CLEAR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_AVG_CLEAR     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_AVG_CLEAR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_AVG_CLEAR_EXTRACT
TOTAL = ZSDSV_AVG_CLEAR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_AVG_CLEAR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_AVG_CLEAR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_AVG_CLEAR_EXTRACT
TOTAL = ZSDSV_AVG_CLEAR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_AVG_CLEAR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_AVG_CLEAR'
...
TOTAL = ZSDSV_AVG_CLEAR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_AVG_CLEAR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_AVG_CLEAR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_AVG_CLEAR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_AVG_CLEAR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_AVG_CLEAR_EXTRACT
TOTAL = ZSDSV_AVG_CLEAR_TOTAL
