...
*&
*&---------------------------------------------------------------------*
REPORT ZSDSMMR0680 MESSAGE-ID ZSDSMM01.
...
TYPES : BEGIN OF GY_RESULT,
  ...
  MATERIAL         TYPE ZSDSMMT024-MATERIAL,
  BATCH            TYPE ZSDSMMT024-BATCH,
  ENTRY_QNT        TYPE ZSDSMMT024-ENTRY_QNT,
  ENTRY_UOM        TYPE ZSDSMMT024-ENTRY_UOM,
  ENTRY_UOM_ISO    TYPE ZSDSMMT024-ENTRY_UOM_ISO,
  SALES_VAL        TYPE ZSDSMMT024-SALES_VAL,
  ZERO_COUNT       TYPE ZSDSMMT024-ZERO_COUNT,
  MATERIAL_EXTERNA TYPE ZSDSMMT024-MATERIAL_EXTERNA,
  MATERIAL_GUID    TYPE ZSDSMMT024-MATERIAL_GUID,
  MATERIAL_VERSION TYPE ZSDSMMT024-MATERIAL_VERSION,
  LGPBE            TYPE ZSDSMMT024-LGPBE,
  BUCHM            TYPE ZSDSMMT024-BUCHM,
  ERNAM            TYPE ZSDSMMT024-ERNAM,
  ERDAT            TYPE ZSDSMMT024-ERDAT,
  ERZET            TYPE ZSDSMMT024-ERZET,
  AEDAT            TYPE ZSDSMMT024-AEDAT,
  AEZET            TYPE ZSDSMMT024-AEZET,
  AENAM            TYPE ZSDSMMT024-AENAM,
  REMARK           TYPE ZSDSMMT024-REMARK,
  DIF              TYPE ERFMG,
  FLAG             TYPE C,
  ALL              TYPE ZSDSMMT024-BUCHM,
  CHECK            TYPE ZSDSMMT024-BUCHM,
  REMAIN           TYPE ZSDSMMT024-BUCHM,
  PROGRESS         TYPE C LENGTH 255,
  DIFS             TYPE ZSDSMMT024-BUCHM,
  DIF_PER          TYPE C LENGTH 255,
  NONDIF           TYPE ZSDSMMT024-BUCHM,
...
SELECT-OPTIONS : S_GJAHR FOR  ZSDSMMT024-GJAHR,
                 S_IBLNR FOR  ZSDSMMT024-IBLNR,
                 S_ITEM  FOR  ZSDSMMT024-ITEM,
                 S_LGORT FOR  ISEG-LGORT,
                 S_MATNR FOR  ISEG-MATNR,
                 S_LGPBE FOR  ZSDSMMT024-LGPBE.
...
FORM F_GET_DATA.
  ...
  SELECT ISEG~GJAHR,
         ...
         MARD~LGPBE
   FROM ISEG
   LEFT JOIN MARD ON ISEG~MATNR EQ MARD~MATNR AND
                     ISEG~LGORT EQ MARD~LGORT AND
                     MARD~WERKS EQ '1000'
   LEFT JOIN MARA ON ISEG~MATNR EQ MARA~MATNR
...
FORM F_BUILD_FCAT.
  ...
  CLEAR LS_FCAT.
  LS_FCAT-REF_TABNAME = 'ZSDSMMT024'.
