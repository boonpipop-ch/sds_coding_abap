...
CLASS LCL_DATA IMPLEMENTATION.
  ...
  METHOD START_PROCESS.
    ...
    SELECT A~RUNNG,
           ...
           A~EBELN,
           A~POSIT
      FROM ZSDSMMT002 AS A
      WHERE A~EBELN IN @S_EBELN

*      AND A~FLAGD EQ @SPACE

        ORDER BY RUNNG DESCENDING,
           ERNAM DESCENDING,
           ERDAT DESCENDING,
           ERZET DESCENDING
  ...
  INTO TABLE @DATA(LT_TMP).
    ...
    LOOP AT GT_RESULT ASSIGNING FIELD-SYMBOL(<LFS_RESULT>).
      READ TABLE LT_TMP ASSIGNING FIELD-SYMBOL(<LFS_TMP>)
        WITH KEY EBELN = <LFS_RESULT>-EBELN.
*

      IF SY-SUBRC = 0.
        <LFS_RESULT>-RUNNG = <LFS_TMP>-RUNNG.
        <LFS_RESULT>-STATU = <LFS_TMP>-STATU.
        <LFS_RESULT>-REMAK = <LFS_TMP>-REMAK.
        <LFS_RESULT>-ERNAM = <LFS_TMP>-ERNAM.
        <LFS_RESULT>-ERDAT = <LFS_TMP>-ERDAT.
        <LFS_RESULT>-ERZET = <LFS_TMP>-ERZET.
        <LFS_RESULT>-POSIT = <LFS_TMP>-POSIT.
