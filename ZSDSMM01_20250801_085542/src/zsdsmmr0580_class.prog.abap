...
*  CALL METHOD document->new_line.
  ...
  METHOD SEND_DATA_API.
    ...
    LOOP AT GT_RESULT INTO LS_RESULT.
      ...
      LS_DATA-VBELN           = LS_RESULT-MBLNR.
      LS_DATA-LFDAT           = LS_RESULT-CPUDT.
      LS_DATA-ERDAT           = LS_RESULT-CPUDT.
      LS_DATA-POSNR           = LS_RESULT-ZEILE.
      LS_DATA-MATNR           = LS_RESULT-MATNR.
      LS_DATA-ARKTX           = LS_RESULT-MAKTX.
      LV_QTY                  = LS_RESULT-MENGE.
      REPLACE ALL OCCURRENCES OF PCRE '[ ]+' IN LV_QTY WITH ''.
      LS_DATA-LGMNG           = LV_QTY.
...
*      LS_DATA-SPSOLC          = LS_OUTTAB-SPSOLC.
  ...
  METHOD GET_VENDOR_HOLD.
    CONSTANTS : BEGIN OF LC_CON,
                  REPID TYPE C LENGTH 22 VALUE 'ZSDSMMR0580',
