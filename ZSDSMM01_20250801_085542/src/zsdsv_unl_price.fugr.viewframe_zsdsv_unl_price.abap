*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_UNL_PRICE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_UNL_PRICE     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_UNL_PRICE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_UNL_PRICE_EXTRACT
TOTAL = ZSDSV_UNL_PRICE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_UNL_PRICE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_UNL_PRICE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_UNL_PRICE_EXTRACT
TOTAL = ZSDSV_UNL_PRICE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_UNL_PRICE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_UNL_PRICE'
...
TOTAL = ZSDSV_UNL_PRICE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_UNL_PRICE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_UNL_PRICE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_UNL_PRICE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_UNL_PRICE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_UNL_PRICE_EXTRACT
TOTAL = ZSDSV_UNL_PRICE_TOTAL
