...
CLASS LCL_DATA DEFINITION.
  PUBLIC SECTION.
    ...
    CLASS-METHODS :
      ...
      GET_VENDOR_FOR_CHECK_JTEPA IMPORTING i_Data   TYPE LFA1-LIFNR
                                 RETURNING VALUE(R) TYPE LFA1-LIFNR.
...
CLASS LCL_DATA IMPLEMENTATION.
  ...
  ENDMETHOD.
  METHOD GET_VENDOR_FOR_CHECK_JTEPA.
    CALL FUNCTION 'Z_DSCA_GET_CUSTOMER_IGOM_ORG'
      EXPORTING
        IF_PARTNER           = i_Data
      IMPORTING
        EF_IGOM_BP           = R
