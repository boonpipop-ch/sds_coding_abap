...
TYPES : BEGIN OF GY_RESULT,
          GUID  TYPE MMIM_PREDOC_ORG-GUID ,
          REFID TYPE MMIM_PREDOC_ORG-REFID,
          FIELD type MMIM_PRED-FIELD,
          VALUE TYPE MMIM_PRED-VALUE,
          CHECK   TYPE C,
        END OF GY_RESULT.
...
DATA : GT_ZSDSMMT002 TYPE TABLE OF ZSDSMMT002.
