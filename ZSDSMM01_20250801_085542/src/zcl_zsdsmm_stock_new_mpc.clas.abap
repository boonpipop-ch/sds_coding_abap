class ZCL_ZSDSMM_STOCK_NEW_MPC definition
  public
...
public section.
  ...
  types:
TT_FGSUM type standard table of TS_FGSUM .
  types:
  ...
  types:
  begin of TS_FGDETAIL,
     ID type string,
     WERKS type string,
  end of TS_FGDETAIL .
  types:
TT_FGDETAIL type standard table of TS_FGDETAIL .
  types:
  begin of TS_RANGESMAT,
  ...
  types:
TT_RANGESMAT type standard table of TS_RANGESMAT .
  types:
  begin of TS_RANGESLOCATION,
     SIGN type C length 1,
     OPTION type C length 2,
     LOW type C length 4,
     HIGH type C length 4,
  end of TS_RANGESLOCATION .
  types:
TT_RANGESLOCATION type standard table of TS_RANGESLOCATION .
  types:
  begin of TS_RANGESPH1,
     SIGN type C length 1,
     OPTION type C length 2,
     LOW type C length 5,
  ...
  types:
TT_RANGESPH1 type standard table of TS_RANGESPH1 .
  types:
  begin of TS_RANGESPH2,
     SIGN type C length 1,
     OPTION type C length 2,
     LOW type C length 5,
     HIGH type C length 5,
  ...
  types:
TT_RANGESPH2 type standard table of TS_RANGESPH2 .
  types:
  begin of TS_RANGESPH3,
     SIGN type C length 1,
     OPTION type C length 2,
     LOW type C length 8,
  ...
  types:
TT_RANGESPH3 type standard table of TS_RANGESPH3 .
  types:
     TS_DATASUM type ZSDSMMS055 .
  types:
TT_DATASUM type standard table of TS_DATASUM .
  types:
     TS_DATADETAIL type ZSDSMMS055 .
  types:
TT_DATADETAIL type standard table of TS_DATADETAIL .
  types:
  begin of TS_SPDETAIL,
     ID type string,
     WERKS type string,
  end of TS_SPDETAIL .
  types:
TT_SPDETAIL type standard table of TS_SPDETAIL .
  types:
  begin of TS_SPSUM,
     ID type string,
     WERKS type string,
  ...
  types:
TT_SPSUM type standard table of TS_SPSUM .

  constants GC_DATADETAIL type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'dataDetail' ##NO_TEXT.
  constants GC_DATASUM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'dataSum' ##NO_TEXT.
  constants GC_FGDETAIL type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'fgDetail' ##NO_TEXT.
  constants GC_FGSUM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'fgSum' ##NO_TEXT.
  constants GC_RANGESLOCATION type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'rangesLocation' ##NO_TEXT.
  constants GC_RANGESMAT type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'rangesMat' ##NO_TEXT.
  constants GC_RANGESPH1 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'rangesPh1' ##NO_TEXT.
  constants GC_RANGESPH2 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'rangesPh2' ##NO_TEXT.
  constants GC_RANGESPH3 type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'rangesPh3' ##NO_TEXT.
  constants GC_SPDETAIL type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'spDetail' ##NO_TEXT.
  constants GC_SPSUM type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'spSum' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSDSMM_STOCK_NEW_MPC======CP' ##NO_TEXT.

  methods DEFINE_FGSUM
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_FGDETAIL
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_RANGESMAT
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_RANGESLOCATION
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_RANGESPH1
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_RANGESPH2
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_RANGESPH3
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_DATASUM
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_DATADETAIL
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SPDETAIL
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_SPSUM
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZSDSMM_STOCK_NEW_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSDSMM_STOCK_NEW_SRV' ).

define_fgsum( ).
define_fgdetail( ).
define_rangesmat( ).
define_rangeslocation( ).
define_rangesph1( ).
define_rangesph2( ).
define_rangesph3( ).
define_datasum( ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'fgSumXrangesMat' "#EC NOTEXT
                            iv_left_type        = 'fgSum' "#EC NOTEXT
                            iv_right_type       = 'rangesMat' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgDetailXrangesMat' "#EC NOTEXT
                            iv_left_type        = 'fgDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesMat' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgDetailXrangesPh1' "#EC NOTEXT
                            iv_left_type        = 'fgDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesPh1' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgDetailXrangesPh2' "#EC NOTEXT
                            iv_left_type        = 'fgDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesPh2' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgDetailXrangesPh3' "#EC NOTEXT
                            iv_left_type        = 'fgDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesPh3' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgDetailXrangesLocation' "#EC NOTEXT
                            iv_left_type        = 'fgDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesLocation' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgSumXrangesPh1' "#EC NOTEXT
                            iv_left_type        = 'fgSum' "#EC NOTEXT
                            iv_right_type       = 'rangesPh1' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgSumXrangesPh2' "#EC NOTEXT
                            iv_left_type        = 'fgSum' "#EC NOTEXT
                            iv_right_type       = 'rangesPh2' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgSumXrangesPh3' "#EC NOTEXT
                            iv_left_type        = 'fgSum' "#EC NOTEXT
                            iv_right_type       = 'rangesPh3' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgSumXdataSum' "#EC NOTEXT
                            iv_left_type        = 'fgSum' "#EC NOTEXT
                            iv_right_type       = 'dataSum' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'fgDetailXdataDetail' "#EC NOTEXT
                            iv_left_type        = 'fgDetail' "#EC NOTEXT
                            iv_right_type       = 'dataDetail' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spDetailXdataDetail' "#EC NOTEXT
                            iv_left_type        = 'spDetail' "#EC NOTEXT
                            iv_right_type       = 'dataDetail' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spDetailXrangesLocation' "#EC NOTEXT
                            iv_left_type        = 'spDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesLocation' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spDetailXrangesMat' "#EC NOTEXT
                            iv_left_type        = 'spDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesMat' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spDetailXrangesPh1' "#EC NOTEXT
                            iv_left_type        = 'spDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesPh1' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spDetailXrangesPh2' "#EC NOTEXT
                            iv_left_type        = 'spDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesPh2' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spDetailXrangesPh3' "#EC NOTEXT
                            iv_left_type        = 'spDetail' "#EC NOTEXT
                            iv_right_type       = 'rangesPh3' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spSumXdataSum' "#EC NOTEXT
                            iv_left_type        = 'spSum' "#EC NOTEXT
                            iv_right_type       = 'dataSum' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spSumXrangesMat' "#EC NOTEXT
                            iv_left_type        = 'spSum' "#EC NOTEXT
                            iv_right_type       = 'rangesMat' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spSumXrangesPh1' "#EC NOTEXT
                            iv_left_type        = 'spSum' "#EC NOTEXT
                            iv_right_type       = 'rangesPh1' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spSumXrangesPh2' "#EC NOTEXT
                            iv_left_type        = 'spSum' "#EC NOTEXT
                            iv_right_type       = 'rangesPh2' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_true ). "#EC NOTEXT
 lo_association = model->create_association(
                            iv_association_name = 'spSumXrangesPh3' "#EC NOTEXT
                            iv_left_type        = 'spSum' "#EC NOTEXT
                            iv_right_type       = 'rangesPh3' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = 'N'  "#EC NOTEXT
...
* Navigation Properties for entity - fgSum
lo_entity_type = model->get_entity_type( iv_entity_name = 'fgSum' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionMat' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_MAT' "#EC NOTEXT
                                                              iv_association_name = 'fgSumXrangesMat' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionPh3' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_PH3' "#EC NOTEXT
                                                              iv_association_name = 'fgSumXrangesPh3' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionPh2' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_PH2' "#EC NOTEXT
                                                              iv_association_name = 'fgSumXrangesPh2' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionPh1' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_PH1' "#EC NOTEXT
                                                              iv_association_name = 'fgSumXrangesPh1' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'dataSum' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SUM_DATA' "#EC NOTEXT
                                                              iv_association_name = 'fgSumXdataSum' ). "#EC NOTEXT
* Navigation Properties for entity - fgDetail
lo_entity_type = model->get_entity_type( iv_entity_name = 'fgDetail' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionMat' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_MAT' "#EC NOTEXT
                                                              iv_association_name = 'fgDetailXrangesMat' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionPh1' "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionPh3' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_PH3' "#EC NOTEXT
                                                              iv_association_name = 'fgDetailXrangesPh3' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'dataDetail' "#EC NOTEXT
                                                              iv_abap_fieldname = 'DETAIL_DATA' "#EC NOTEXT
                                                              iv_association_name = 'fgDetailXdataDetail' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionLocation' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_LOCATION' "#EC NOTEXT
                                                              iv_association_name = 'fgDetailXrangesLocation' ). "#EC NOTEXT
* Navigation Properties for entity - spDetail
lo_entity_type = model->get_entity_type( iv_entity_name = 'spDetail' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionMat' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_MAT' "#EC NOTEXT
                                                              iv_association_name = 'spDetailXrangesMat' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionPh1' "#EC NOTEXT
...
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionLocation' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_LOCATION' "#EC NOTEXT
                                                              iv_association_name = 'spDetailXrangesLocation' ). "#EC NOTEXT
* Navigation Properties for entity - spSum
lo_entity_type = model->get_entity_type( iv_entity_name = 'spSum' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionMat' "#EC NOTEXT
                                                              iv_abap_fieldname = 'SELECTION_MAT' "#EC NOTEXT
                                                              iv_association_name = 'spSumXrangesMat' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'selectionPh3' "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'dataDetail' iv_def_entity_set = abap_true ). "#EC NOTEXT

***********************************************************************************************************************************
*Properties
***********************************************************************************************************************************

lo_property = lo_entity_type->create_property( iv_property_name = 'CustName' iv_abap_fieldname = 'CUST_NAME' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'QtQty' iv_abap_fieldname = 'QT_QTY' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SalesGroup' iv_abap_fieldname = 'SALES_GROUP' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'ResQty' iv_abap_fieldname = 'RES_QTY' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SalesOffice' iv_abap_fieldname = 'SALES_OFFICE' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SalesName' iv_abap_fieldname = 'SALES_NAME' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PrQty' iv_abap_fieldname = 'PR_QTY' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Zzcav' iv_abap_fieldname = 'ZZCAV' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Ph1' iv_abap_fieldname = 'PH1' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Ph2' iv_abap_fieldname = 'PH2' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
lo_property->set_maxlength( iv_max_length = 5 ). "#EC NOTEXT
lo_property->set_creatable( abap_false ).
lo_property->set_updatable( abap_false ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Ph3' iv_abap_fieldname = 'PH3' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Verpr' iv_abap_fieldname = 'VERPR' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Stprs' iv_abap_fieldname = 'STPRS' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'UrQty' iv_abap_fieldname = 'UR_QTY' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'SoQty' iv_abap_fieldname = 'SO_QTY' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'DoQty' iv_abap_fieldname = 'DO_QTY' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'BlockQty' iv_abap_fieldname = 'BLOCK_QTY' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'TransfertQty' iv_abap_fieldname = 'TRANSFERT_QTY' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'Datei' iv_abap_fieldname = 'DATEI' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZSDSMMS055'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
  endmethod.


  method DEFINE_DATASUM.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'dataSum' iv_def_entity_set = abap_true ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'fgDetail' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSDSMM_STOCK_NEW_MPC=>TS_FGDETAIL' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'fgDetailSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'fgSum' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSDSMM_STOCK_NEW_MPC=>TS_FGSUM' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'fgSumSet' ). "#EC NOTEXT
...
***********************************************************************************************************************************
*   ENTITY - rangesLocation
***********************************************************************************************************************************

lo_entity_type = model->create_entity_type( iv_entity_type_name = 'rangesLocation' iv_def_entity_set = abap_true ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSDSMM_STOCK_NEW_MPC=>TS_RANGESLOCATION' ). "#EC NOTEXT
  endmethod.


  method DEFINE_RANGESMAT.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'rangesMat' iv_def_entity_set = abap_true ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSDSMM_STOCK_NEW_MPC=>TS_RANGESMAT' ). "#EC NOTEXT
  endmethod.


  method DEFINE_RANGESPH1.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'rangesPh1' iv_def_entity_set = abap_true ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSDSMM_STOCK_NEW_MPC=>TS_RANGESPH1' ). "#EC NOTEXT
  endmethod.


  method DEFINE_RANGESPH2.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'rangesPh2' iv_def_entity_set = abap_true ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSDSMM_STOCK_NEW_MPC=>TS_RANGESPH2' ). "#EC NOTEXT
  endmethod.


  method DEFINE_RANGESPH3.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'rangesPh3' iv_def_entity_set = abap_true ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSDSMM_STOCK_NEW_MPC=>TS_RANGESPH3' ). "#EC NOTEXT
  endmethod.


  method DEFINE_SPDETAIL.
*&---------------------------------------------------------------------*
*&           Generated code for the MODEL PROVIDER BASE CLASS         &*
*&                                                                     &*
*&  !!!NEVER MODIFY THIS CLASS. IN CASE YOU WANT TO CHANGE THE MODEL  &*
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'spDetail' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSDSMM_STOCK_NEW_MPC=>TS_SPDETAIL' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'spDetailSet' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'spSum' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSDSMM_STOCK_NEW_MPC=>TS_SPSUM' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'spSumSet' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20241206090316'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'fgSum'.                            "#EC NOTEXT
...
ls_text_element-artifact_name          = 'id'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'fgDetail'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'rangesMat'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Sign'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'rangesLocation'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Sign'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'rangesPh1'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Sign'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'rangesPh2'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'Sign'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'rangesPh3'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'QtQty'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
ls_text_element-text_symbol            = '075'.              "#EC NOTEXT
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'ResQty'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'PrQty'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Kbetr'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Verpr'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Stprs'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'UrQty'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'SoQty'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'DoQty'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'BlockQty'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'TransfertQty'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'Datei'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'CustName'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataDetail'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'SalesGroup'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataDetail'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'SalesOffice'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataDetail'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'SalesName'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'dataDetail'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'id'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'spDetail'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
...
ls_text_element-artifact_name          = 'id'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'spSum'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
