*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSDSV_SLOC_TYPE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSDSV_SLOC_TYPE     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSDSV_SLOC_TYPE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSDSV_SLOC_TYPE_EXTRACT
TOTAL = ZSDSV_SLOC_TYPE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSDSV_SLOC_TYPE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSDSV_SLOC_TYPE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_SLOC_TYPE_EXTRACT
TOTAL = ZSDSV_SLOC_TYPE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSDSV_SLOC_TYPE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSDSV_SLOC_TYPE'
...
TOTAL = ZSDSV_SLOC_TYPE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSDSV_SLOC_TYPE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSDSV_SLOC_TYPE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSDSV_SLOC_TYPE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSDSV_SLOC_TYPE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSDSV_SLOC_TYPE_EXTRACT
TOTAL = ZSDSV_SLOC_TYPE_TOTAL
