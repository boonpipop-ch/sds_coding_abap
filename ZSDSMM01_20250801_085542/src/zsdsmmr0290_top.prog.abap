...
TYPES : BEGIN OF GY_RESULT,
          ...
          MESSG TYPE C LENGTH 200,
          CHECK TYPE C,
        END OF GY_RESULT.

TYPES : BEGIN OF GY_SELECTION,
          WEBNO TYPE CHAR20,
        END OF GY_SELECTION.
...
DATA : GT_SELECTION TYPE TABLE OF GY_SELECTION WITH HEADER LINE,
       GS_SELECTION TYPE GY_SELECTION.
